...
/**
 * Retrieves Multiple Classrooms by an array of IDs from the Supabase database.
 *
 * @param supabase The Supabase client to use.
 * @param ids The array of IDs for the Classrooms to retrieve.
 *
 * @returns A Backend Return of the Classrooms Array.
 */
export default async function getMultipleClassroomsByIDs(
  ...
  const classrooms = data.map(data => ({
