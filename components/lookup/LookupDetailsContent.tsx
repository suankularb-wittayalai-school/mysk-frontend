...
import { useAnimationConfig, transition } from "@suankularb-components/react";
...
const LookupDetailsContent: StylableFC<{
  ...
  return (
    <motion.section
      ...
      style={style}
      className={cn(
        `flex grow flex-col gap-5 overflow-auto rounded-t-lg bg-surface-1 p-4
        sm:overflow-visible md:overflow-auto`,
        className,
      )}
    >
      {children}
